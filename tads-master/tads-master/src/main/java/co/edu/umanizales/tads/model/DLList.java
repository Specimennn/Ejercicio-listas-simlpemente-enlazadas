...
public class DLList {
    ...
    public void deleteByPlace (int place) throws DLListException  {
        ...
        //defino un ayudante y un countador para saber cuantos pasos llevo
        DLNode temp = head;
        int steps = 1;
    ...
    public float averageAge() throws DLListException{
            ...
            //defino dos variables int para countar el total de edad
            DLNode temp = head;
            int ageTotal = 0;
    ...
    public int getAmountOfPetsByLocation(String code){
        ...
        //ciclo por la lista
            ...
            while(temp != null){
                ...
                //si me encuentro a una mascota de la ubicacion, aumento el countador
            ...
            //despues de haber ciclado por toda la lista retorno el countador
        return count;
    }
